...
const SmallProjectCard: React.FC<{ project: SmallProject }> = ({ project }) => {
  return (
    <div className="w-80 h-64 border border-gray-400 flex flex-col justify-start items-start">
      ...
      <div className="self-stretch flex-grow p-4 border-t border-gray-400 flex flex-col justify-between items-start gap-4">
        ...
        <a href={project.projectUrl} target="_blank" rel="noopener noreferrer" className="px-4 py-2 border border-gray-400 flex justify-center items-center text-gray-400 text-base font-medium">
          Visit
        </a>
      </div>
    </div>
