...
const ProjectCard: React.FC<{ project: Project }> = ({ project }) => {
  return (
    <div className="flex flex-col justify-between border border-primary w-full md:max-w-md lg:max-w-lg">
      <div className="relative w-auto">
        <Image width={384} height={250} className="border-b border-primary" src={project.imageUrl} alt={project.title} layout="responsive" />
        <div className="p-2 flex justify-start items-start gap-2 flex-wrap">
